...
if [ -s py.files ]; then        # Only if py file exists
    ...
    ###################################
    # Run1:  
    python3 MathTest1.py &> run1.messages
    #----------------------------------
    # Run2: 
    python3 MathTest2.py &> run2.messages
    #----------------------------------
    # Run3: 
    python3 MathTest3.py &> run3.messages
    ###################################
    #trap '-'
